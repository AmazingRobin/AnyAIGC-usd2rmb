...
```
切换前   Claude Opus 5    $0.5736 / 1M tokens
切换后   Claude Opus 5    ¥3.9005 / 1M tokens  （汇率 6.8，以近半个月汇率平均值计算）
```
...
- [AnyAIGC 汇率助手](#anyaigc-汇率助手)
  ...
  - [使用教程](#使用教程)
    ...
    - [第 2 步：找到切换面板](#第-2-步找到切换面板)
    - [第 3 步：设置汇率](#第-3-步设置汇率)
    - [第 4 步：切换币种](#第-4-步切换币种)
    - [翻页、筛选后会怎样](#翻页筛选后会怎样)
  - [常见问题](#常见问题)
  - [浏览器兼容性](#浏览器兼容性)
  - [从源码构建](#从源码构建)
